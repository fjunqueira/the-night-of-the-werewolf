...
void Image::extractAndPlotTo(Image* dest, int plotStartingX, int plotStartingY, int extractStartingX, int extractStartingY, int extractWidth, int extractHeight)
{
